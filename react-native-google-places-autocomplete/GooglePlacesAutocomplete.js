...
export default class GooglePlacesAutocomplete extends Component {
        ...
        if (request.status === 200) {
          ...
          if (responseJSON.status === 'OK') {
            if (this._isMounted === true) {
              ...
              this.props.getCurrentValue(this.state.text);
  ...
  _renderRowData(rowData) {
    ...
    return (
      <Text style={[{flex: 1, paddingVertical: 10}, defaultStyles.description, this.props.styles.description, rowData.isPredefinedPlace ? this.props.styles.predefinedPlacesDescription : {}]}
        numberOfLines={1}
      >
  ...
  _renderRow(rowData = {}, sectionID, rowID) {
    return (
      <ScrollView
        ...
        <TouchableHighlight
          style={{ marginLeft: 26.7, width: WINDOW.width - 26.7, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(255, 255, 255, 0.11)' }}
          onPress={() => this._onPress(rowData)}
          underlayColor={this.props.listUnderlayColor || "#1DC43C"}
        >
    ...
    if ((this.state.text !== '' || this.props.predefinedPlaces.length || this.props.currentLocation === true) && this.state.listViewDisplayed === true) {
      return (
        <FlatList
          ...
          _renderSeparator={this._renderSeparator}
          {...this.props}
        />
      );
    }
