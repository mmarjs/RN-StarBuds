...
import { View, Image, Text, ActivityIndicator, Dimensions ,ImageBackground} from 'react-native';
...
class ConfirmEmail extends Component {
	...
	renderLogo() {
		return (<Image style={ConfirmEmailStyle.headerImage} source={Images.whitelogo}/>);
	}
	...
	render() {
		...
		<ImageBackground
          style={ConfirmEmailStyle.imageContainer}
          source={Images.background_image}></ImageBackground>
		<View style={{ alignItems: "center", marginTop : - (screenHeight * 0.9) }}>
					{this.renderLogo()}
					{this.renderText()}
					{this.renderButton()}
				</View>
				{/* <View style={ConfirmEmailStyle.part2}>
					<Image style={ConfirmEmailStyle.imageStyle} source={Images.background_image}/>
				</View> */}
			</View>
		);
	}
