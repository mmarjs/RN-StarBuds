    ...
    if(messageType === 'post'){
      ...
      <View style={ChatMessagesStyle.postContainer}>
        ...
        <View style={{flex:0.7, justifyContent:'center'}}>
          <Text style={[{color:'rgba(255, 255, 255, 0.67)'},ChatMessagesStyle.universalFont]}> {post.userDetail[0].name} </Text>
        </View>
  ...
  renderBubble = (props) => {
    ...
    return (
      <Bubble
        ...
        textProps={{ style: { color: messageType === 'text' ?'#FFF': 'rgba(255, 255, 255, 0.22)' } }}
        wrapperStyle={{
          left: {
    ...
    return (
      ...
      >
        <View style={{marginRight: 10, marginBottom: 10}}>
          <Image source={Images.sendActive} resizeMode={'contain'} style={{height:23, width:19.3}}/>
        </View>
      </Send>
    );
  }
    ...
    return(
      <View style={ChatMessagesStyle.chatMessageContainer}>
        ...
        <GiftedChat
          ...
          dayDisplayStyle = {{color: 'rgba(255, 255, 255, 0.40)',fontSize: 11.9}}
          ...
          InputContainerStyle = {{backgroundColor:'#000'}} //InputContainerStyle
...
ChatMessages.navigationOptions = ({ navigation }) => { 
  return {
    ...
    headerRight: (
      ...
      >
        <View style={[Styles.headerRightImage, ChatMessagesStyle.infoIconStyle]}>
