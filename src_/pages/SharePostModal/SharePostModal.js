      ...
      >
          ...
          <View style={{backgroundColor: '#FFFFFF'}}>
            { this.state.searchMode ?
             <View style={[Styles.modalTitleBar, {justifyContent: 'flex-start'}]}>
              ...
              <TextInput
                ...
                style={SharePostModalStyle.inputStyle}
            ...
            :
              ...
              <View  style={Styles.modalTitleBar}>
                ...
                <Text style={[Styles.modalTitle,{fontSize:16.5, backgroundColor: 'transparent'}]}>
                  SEND TO
                </Text>
            ...
            <View style={SharePostModalStyle.userListContainer}>
              ...
              >
              {filteredUsersByName.map(this.renderScrollViewItem)}
            </ScrollView>
            </View>
            {allUnselected ?
              <View >
                <TouchableOpacity style={SharePostModalStyle.closeButtonWrapper} onPress={()=>{

                  let unselectedUserList = this.state
                    .userList
                    .map((user) => {
                      user.isSelected = false;
                      return user
                  ...
                  <Image source={Images.closeIconWhite} style={{height:13.3, width:13}} />
                </TouchableOpacity>
              </View>
              :
              <TouchableOpacity style={SharePostModalStyle.sendButton} onPress={this.sendChat}>
                  <Text style={SharePostModalStyle.sendText}> SEND </Text>
              </TouchableOpacity>
            }
          </View>
          </KeyboardAvoidingView>
