...
rotatedCGImage = cgImage;
          ...
          CFRelease(destination);
            ...
            UIImage *imageTaked = [UIImage imageWithCGImage:rotatedCGImage];
...
//            UIImage *  newImage =  imageCropped.normalizedImage;
            NSMutableData * data = [UIImagePNGRepresentation(imageCropped) mutableCopy];
          [self saveImage:data target:target metadata:imageMetadata resolve:resolve reject:reject];
...
//    NSNumber* orientationValue = [img valueForProperty:@"ALAssetPropertyOrientation"];
//    if (orientationValue) {
